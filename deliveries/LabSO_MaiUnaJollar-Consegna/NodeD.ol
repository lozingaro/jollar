...
define Visualizer {
  ...
  if (scelto == "si") {
    ...
    scope(timeVisualizer){
      ...
      println@Console( "TimeStamp for server request: " + reqTime )()
    };
      ...
      if (activeNode.nodeA){
        ...
        define VerificaFermat{
          ...
          define InviaFineTransazione
          {
              ...
              if(activeNode.nodeA)
                inviaMessaggio@AsendToD(m);
              if(activeNode.nodeC)
                inviaMessaggio@BsendToD(m);
              if(activeNode.nodeD)
                inviaMessaggio@CsendToD(m)
          }
          ...
          define exitmenu {
            ...
            println@Console("Digita '3' per inviare jollar a C")();
            ...
            if(inserimento == 1 || inserimento == 2 || inserimento == 3){
              ...
              sendNumber@ServersendToD(x);
              z.z = string("Richiesta al Server da parte di D");
              requestTimeStampToServer@ServersendToD(z)(y);
              ...
              if(inserimento == 1){
                inviaMessaggio@AsendToD(m);
                m.m = string("In arrivo JOLLAR a A inviati da D");
                inviaMessaggio@AsendToD(m);
                ...
                //exitmenu
                  ...
                  inviaMessaggio@BsendToD(m);
                  m.m = string("In arrivo JOLLAR a B inviati da D");
                  inviaMessaggio@BsendToD(m);
                  ...
                  //exitmenu
                    ...
                    inviaMessaggio@CsendToD(m);
                    m.m = string("In arrivo JOLLAR a C inviati da D");
                    inviaMessaggio@CsendToD(m);
              ...
              define chainVerifyResult {
                ...
                define WaitForMessage{
                  ...
                  if(m.m == "chain"){
                    ...
                    //invia messaggio se VerificaCunningham e' verificata oppure  no, e la manda da A a B
                    if(chain.creator == "B")
                    {
                      inviaMessaggio@BsendToD(m)		//invia messaggio se VerificaCunningham e' verificata oppure  no, e la manda da A a B
                      };	//riceve la stringa "catena verifica"
                      //elseifA
                      if(chain.creator == "C")
                      {
                        inviaMessaggio@CsendToD(m)		//invia messaggio se VerificaCunningham e' verificata oppure  no, e la manda da A a B
                      }
                    ...
                    {
                      inviaLung@AsendToD(lunghezzaCatena)
                    }
                    else if(m.m == "CALCOLO LUNGHEZZA B")
                    {
                      inviaLung@BsendToD(lunghezzaCatena)
                    }
                    else if(m.m == "CALCOLO LUNGHEZZA C")
                    {
                      inviaLung@CsendToD(lunghezzaCatena)
                    };
                  ...
                  define CreaCatene {
                    if(contatoreCatene == 1){
                      ...
                      {
                        VerificaStatoNodi;
                          m.m = string("CALCOLO LUNGHEZZA D");
                          ...
                          if (lunghezzaInviataC > lunghezzaCatena)
                      ...
                      define VerificaBroadcast{
                        ...
                        //se il nodo A riceve il numero di verifiche UGUALI al numero di nodiAttivi
                        //il nodo A si auto assegna  la REWARD iniziale di 6 jollar
                      ...
                      */
                      ...
                      main
                      {
                        println@Console("node D started \n")();
