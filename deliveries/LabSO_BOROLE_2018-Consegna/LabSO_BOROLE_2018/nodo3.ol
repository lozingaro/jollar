...
init
{
	...
	nodo3.numeroJollar = 0;
	nodo3.id_node = "nodo3";
	println@Console( "Ho creato il nodo: " + nodo3.id_node )();
	println@Console( "Chiave pubblica nodo: " + nodo3.publicKey )();
	println@Console( "Numero di jollar: " + nodo3.numeroJollar )();

	nodoConnesso@PP7("Connesso");
		informazioniNodo3@PP13(nodo3)
}
...
main
{
	...
	//blocco1.n_catena = ;
		...
		println@Console( "" )();
	  	...
	  	;
	  		...
	  		if( rispostaNodoArrivatoPrima == "nodo3" ) {
	...
	//servizio per la transazione tra il nodo1 e il nodo3
 		[nuovaTransazione(nuovaTransazione)(risultatoTransazione)
 	{
 		...
 		nodo3.numeroJollar = nodo3.numeroJollar + nuovaTransazione.jollar;
 	...
 	println@Console( "Ora i tuoi jollar sono: "+ nodo3.numeroJollar )();
 	...
 	//crea il blocco con i dati ricevuti
		...
		println@Console( "" )();
	  	...
	  	;
	  		...
	  		println@Console( "------Blockchain scaricata------")();
	  		println@Console( "" )();
	  		numeroJollarNodo3@PP13(nodo3.numeroJollar)
