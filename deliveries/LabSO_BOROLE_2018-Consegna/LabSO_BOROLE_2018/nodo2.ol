...
outputPort PP5 {
	Location: "socket://localhost:8040"
	Protocol: sodep
	Interfaces: BlockchainInterface
}
...
init
{
  	md5@MessageDigest("nodo2")(rispostaHashSegreto);
	md5@MessageDigest("hashnodo2")(rispostaHashPubblico);
	nodo2.publicKey = rispostaHashPubblico;
	nodo2.privateKey = rispostaHashSegreto;
	nodo2.numeroJollar = 0;
	nodo2.id_node = "nodo2";
	println@Console( "Ho creato il nodo: " + nodo2.id_node )();
	println@Console( "Chiave pubblica nodo: " + nodo2.publicKey )();
	println@Console( "Numero di jollar: " + nodo2.numeroJollar )();

	nodoConnesso@PP1("connesso");
		informazioniNodo2@PP13(nodo2)
}
...
main
{
	...
	println@Console( "---------------------------------------------" )();
 	...
 	[nuovaTransazione(nuovaTransazione)(risultatoTransazione)
 	{
 		...
 		nodo2.numeroJollar = nodo2.numeroJollar + nuovaTransazione.jollar;
 	...
 	//stampo aggiornamento jollar attuale nodo
 	println@Console( "Hai ricevuto: " + nuovaTransazione.jollar + " jollar da --> " + 
 		nuovaTransazione.nodeSeller )();
 	println@Console( "Ora i tuoi jollar sono: "+ nodo2.numeroJollar )();
 	...
 	//riceve i dati dellla transazione per la creazione del blocco
	...
	//blocco1.n_catena = ;
		...
		println@Console( "" )();
	  	...
	  	;
	  		...
	  		if( rispostaNodoArrivatoPrima == "nodo2" ) {
  		  //popola la dificolta del blocco
	  		...
	  		//la proof of work effettuata dai nodi, variabile= blockchainAttuale
	  		println@Console( "Scarico la blockchain attuale..." )();
	  		[blockchainAttuale(blockchainAttuale)];
	  		println@Console( "------Blockchain scaricata------")();
	  		println@Console( "" )();

	  		//ora la variabile blockchain si chiama blockchainAttuale
	  		


	  		//riceve i dati della transazione dal nodo 1 al nodo 3
	  		[creaBloccoDopoTransazione(transazioneRicevuta)(risposta)
			 	{
			 		risposta = "Transazione inviata in broadcast a tutti i nodi presenti nella rete! --> nodo2"
			}];
		...
		println@Console( "" )();
	  	...
	  	;
  		  ...
  		  //popola la dificolta del blocco
	  		...
	  		//riceve i dati della transazione dal nodo 1 al nodo 4
	  		[creaBloccoDopoTransazione(transazioneRicevuta)(risposta)
			 	{
			 		risposta = "Transazione inviata in broadcast a tutti i nodi presenti nella rete! --> nodo2"
			}];
		...
		println@Console( "" )();
	  	...
	  	;
  		  ...
  		  //popola la dificolta del blocco
	  		...
	  		println@Console( "------Blockchain scaricata------")();
	  		println@Console( "" )();
	  		numeroJollarNodo2@PP13(nodo2.numeroJollar)
 	...
 	// nuovo Blocco Broadcast - tutti i nodi consensus	
}
