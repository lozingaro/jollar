...
main {
	...
	if (indexMsg.index == 1) {
		...
		//calcolo primo blocco e aspetto conferma da server (unico peer disponibile ora)
		BMsg.b = 11;
		BMsg.sid = sidMsg.sid;
		isValidChain@JollarCore(BMsg)(risp);
		if(risp){
			println@Console( "Block is valid" )()
			...
			println@Console( "Block rejected" )()
		}
	}
