...
main {
 ...
 md5 @MessageDigest("segreto2")(hashSegreto);
 md5 @MessageDigest("pubblico2")(hashPubblico);
 Nodo2.id = 2;
 Nodo2.publicKey = hashPubblico;
 Nodo2.privateKey = hashSegreto;
 Nodo2.jollarPosseduti = 0;
 collegamentoNodo2 @NetworkVisualizer(Nodo2);
 println @Console("Sei il secondo nodo ad essersi collegato")();

 nodiCollegati(ok);
 println @Console(ok)();
 println @Console("|-------------------------------------------|")();
 println @Console("|             INFORMAZIONI NODO 2           |")();
 println @Console("|-------------------------------------------|")();


 println @Console("ID: " + Nodo2.id)();
 println @Console("Chiave pubblica: " + Nodo2.publicKey)();
 println @Console("Jollar Posseduti: " + Nodo2.jollarPosseduti)();
 ...
 nuovaTransazione(primaTransazione)("Il nodo2 ha ricevuto i J$");
 Nodo2.jollarPosseduti = Nodo2.jollarPosseduti + primaTransazione.jollar;
 println @Console("Hai ricevuto " + primaTransazione.jollar + "J$!")();

 println @Console("In attesa di operazioni......")();

 invioHashGenesi(hashGenesi);
 println @Console(hashGenesi)();
 ...
 proofOfWorkTerminata @NetworkVisualizer(Nodo2.id)(posizione);
 ...
 if (posizione == "Primo") {
  ...
  Nodo2.jollarPosseduti = Nodo2.jollarPosseduti + 6;
  println @Console("Ora possiedi " + Nodo2.jollarPosseduti + "J$")();
  ...
  bloccoN1.firma = Nodo2.privateKey;
 ...
 jollarTotali @NetworkVisualizer(Nodo2.jollarPosseduti);
 ...
 if (posizione == "Primo") {
  ...
  bloccoN2.firma = Nodo2.privateKey;
 ...
 println @Console("DATI TRANSAZIONE 3 SCATICATI")();
 ...
 if (posizione == "Primo") {
  ...
  bloccoN3.firma = Nodo2.privateKey;
