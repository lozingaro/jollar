...
main {
 ...
 md5 @MessageDigest("segreto3")(hashSegreto);
 md5 @MessageDigest("pubblico3")(hashPubblico);
 Nodo3.id = 3;
 Nodo3.publicKey = hashPubblico;
 Nodo3.privateKey = hashSegreto;
 Nodo3.jollarPosseduti = 0;
 collegamentoNodo3 @NetworkVisualizer(Nodo3);
 println @Console("Sei il terzo nodo ad essersi collegato")();

 nodiCollegati(ok);
 println @Console(ok)();
 println @Console("|-------------------------------------------|")();
 println @Console("|             INFORMAZIONI NODO 3           |")();
 println @Console("|-------------------------------------------|")();


 println @Console("ID: " + Nodo3.id)();
 println @Console("Chiave pubblica: " + Nodo3.publicKey)();
 println @Console("Jollar Posseduti: " + Nodo3.jollarPosseduti)();
 ...
 proofOfWorkTerminata @NetworkVisualizer(Nodo3.id)(posizione);
 ...
 if (posizione == "Primo") {
  ...
  Nodo3.jollarPosseduti = Nodo3.jollarPosseduti + 6;
  println @Console("Ora possiedi " + Nodo3.jollarPosseduti + "J$")();
  ...
  bloccoN1.firma = Nodo3.privateKey;
 ...
 jollarTotali @NetworkVisualizer(Nodo3.jollarPosseduti);


 println @Console("In attesa di operazioni.......")();
 nuovaTransazione(secondaTransazione)("Il nodo3 ha ricevuto i J$");
 Nodo3.jollarPosseduti = Nodo3.jollarPosseduti + secondaTransazione.jollar;
 println @Console("Hai ricevuto " + secondaTransazione.jollar + "J$!")();
 ...
 if (posizione == "Primo") {
  ...
  bloccoN2.firma = Nodo3.privateKey;
 ...
 if (posizione == "Primo") {
  ...
  bloccoN3.firma = Nodo3.privateKey;
