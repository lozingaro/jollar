...
/*output per scaricare la blockchain in network visualizer
 una volta che tutti i nodi sono connessi alla rete
 quindi ora possono iniziare transazioni e prof of work*/
outputPort NETWORK {
...
init
{
  md5@MessageDigest("nodo4")(rispostaHashSegreto);
	...
	nodo4.id_node = "nodo4";
	println@Console( "*****************************************************" )();
	println@Console( "Benvenuto nel quarto nodo autostoppista" )();
	println@Console( "*****************************************************" )();
	sleep@Time(300)();
	...
	println@Console( "Portafoglio: " + nodo4.jollarNumb )();
	connect@NODO1("Connesso.");
	infoNode4@TIMESTAMP(nodo4)
}
	...
	//blocco1.n_catena = ;
		...
		println@Console( "ATTENZIONE LA GARA STA PER COMINCIARE" )();
		  ...
		  println@Console( "--------------------------------------" )();
	  		...
	  		endPOW@TIMESTAMP("nodo4")(risposta);
		...
		println@Console( "ATTENZIONE LA GARA STA PER COMINCIARE" )();
 		...
 		[newTransaction(newTransaction)(risultatoTransazione)
	 	{
	 		...
	 		nodo4.jollarNumb = nodo4.jollarNumb + newTransaction.jollar;
	 	...
	 	println@Console( "Ora i tuoi jollar sono: "+ nodo4.jollarNumb )();
		...
		println@Console( "ATTENZIONE LA GARA STA PER COMINCIARE" )();
	  	...
	  	;
			...
			println@Console( "***********************************" )();
	  		...
	  		jollarNumbNodo4@TIMESTAMP(nodo4.jollarNumb);
	  		sendBlockChainNetwork@NETWORK(newBlockChain)
