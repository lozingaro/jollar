...
init
{
  md5@MessageDigest("nodo2")(rispostaHashSegreto);
	...
	nodo2.id_node = "nodo2";
	println@Console( "*****************************************************" )();
	println@Console( "Benvenuto nel secondo nodo autostoppista" )();
	println@Console( "*****************************************************" )();
	sleep@Time(300)();
	...
	println@Console( "Portafoglio: " + nodo2.jollarNumb )();

	connect@NODO1("Connesso.");
		infoNode2@TIMESTAMP(nodo2)
}
...
main
{
	...
	println@Console( "---------------------------------------------" )();
 	...
 	[newTransaction(newTransaction)(risultatoTransazione)
 	{
 		...
 		nodo2.jollarNumb = nodo2.jollarNumb + newTransaction.jollar;
 	...
 	println@Console( "Ora i tuoi jollar sono: "+ nodo2.jollarNumb )();
		...
		println@Console( "ATTENZIONE LA GARA STA PER COMINCIARE" )();
	  	...
	  	;
			...
			println@Console( "			      	42					")();
	  		...
	  		endPOW@TIMESTAMP("nodo2")(risposta);
  		  ...
  		  //popola la dificolta del blocco
	  		...
	  		//la proof of work effettuata dai nodi, variabile= newBlockChain
	  		println@Console( "Scarico la blockchain attuale..." )();
	  		[sendBlockChain(newBlockChain)];
	  		println@Console( "------Blockchain scaricata------")();
	  		println@Console( "" )();

	  		//ora la variabile blockchain si chiama newBlockChain
	  	...
	  	;
			...
			println@Console( "***********************************" )();
	  		...
	  		jollarNumbNodo2@TIMESTAMP(nodo2.jollarNumb)
