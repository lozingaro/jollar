...
main
{
	...
	// aggiornaLocations() e getBlockchain()() saranno chiamati la prima volta dal nodo3
    ...
    {{
        ...
        // sezione critica, mi assicuro che solo un nodo possa mandare un blocco in un dato istante
        ...
        for (j = 0, j < #listaPorte.porta, j++)
        {
            if (listaPorte.porta[j] != myInputPort)
            {
                ...
                println@Console("Blocco mandato a " + Out.location)();
